...
use App\Models\RealEstateOptions;
use Illuminate\Http\Request;
use Illuminate\Http\JsonResponse;
use Illuminate\Validation\ValidationException;

class RealEstateAdOptionsController extends Controller
{
    //
    ...
    {
        try {
            $specs = RealEstateOptions::getClientSpecs();
    ...
    {
        try {
            $specs = RealEstateOptions::ordered()->get();
    ...
    {
        try {
            $spec = RealEstateOptions::where('field_name', $fieldName)->first();
